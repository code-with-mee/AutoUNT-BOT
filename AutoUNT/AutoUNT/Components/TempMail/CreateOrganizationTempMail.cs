...
namespace AutoUNT
{
    public class CreateOrganizationTempMail : AComponent
    {
        private int numOfOrganize = 10;
        private List<ALocator> locators = new List<ALocator>();

        public CreateOrganizationTempMail(Service service, string profile,string account)
        {
            ...
            try
            {
                ...
                if (ele != null)
                {
                    ...
                    else
                    {
                        ...
                        if (index == 5 && increase < numOfOrganize)
                            index = 0;
                    }
                    ...
                    if (index >= locators.Count)
                    {
                        ...
                        Service.components.Add(new CreateProjectTempMail(Service, this.profile, this.account));
                    }
                }
            }
            catch (Exception ex) {}
